// data.jsx — seed data for MCPs, skills, plugins, marketplace
const INITIAL_MCPS = [
...
const MARKET_CATS = ['All', 'Dev', 'Productivity', 'Writing', 'Design', 'Business', 'Web', 'Data', 'Security'];
...
Object.assign(window, { INITIAL_MCPS, INITIAL_SKILLS, INITIAL_PLUGINS, MARKET_ITEMS, MARKET_CATS, KEYBINDINGS });
