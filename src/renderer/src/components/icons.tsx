// icons.tsx — lightweight inline SVG icon set (Lucide-inspired originals)
import { SVGProps } from 'react'

export function Icon({ name, size = 16, ...rest }: { name: string; size?: number } & SVGProps<SVGSVGElement>) {
  const { stroke = 1.75, className = '', style, ...restProps } = rest as {
    stroke?: number
    className?: string
  ...
  const paths: Record<string, React.ReactNode> = {
    ...
    density: <><rect x="3" y="4" width="18" height="6" rx="1.5"/><rect x="3" y="14" width="18" height="6" rx="1.5"/></>,
    ...
    archive: <><rect x="3" y="3" width="18" height="4" rx="1"/><path d="M5 7v13a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V7"/><line x1="10" y1="12" x2="14" y2="12"/></>,
  }
