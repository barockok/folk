...
## 10. Background Adaptation — Neutral Gradient with Geometric Patterns

> **Note:** This section adapts the Composio dark palette for the Local Cowork app's background treatment — neutral gradient fading with geometric square patterns.

### Gradient Background
- Base: Void Black (`#0f0f0f`) fading to Pure Black (`#000000`) via radial or linear gradient
- Optional subtle blue wash: `linear-gradient(180deg, #0f0f0f 0%, #050510 50%, #0f0f0f 100%)` — barely perceptible cool shift
- Cyan glow spot: radial gradient of Electric Cyan at 3-5% opacity, positioned off-center for asymmetric depth

### Geometric Pattern Overlay
- **Shape:** Squares / rectangles arranged in a grid or scattered pattern
- **Stroke:** Border Mist 04-06 (`rgba(255,255,255,0.04-0.06)`) — barely visible, atmospheric
- **Fill:** None (stroke only) or Phantom White (`rgba(255,255,255,0.02)`) for faintest fill
- **Size:** Mix of 40px, 80px, 120px squares at varying rotations (0°, 15°, 45°)
- **Animation (optional):** Slow drift or subtle parallax on scroll — 60s+ cycle, near-imperceptible movement
- **Blend mode:** `overlay` or `soft-light` at low opacity to merge with gradient
